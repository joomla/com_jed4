        ...
        <div class="table-responsive">
            <table class="table table-striped" id="velabandonedreportList">
                ...
                <tr>
                    ...
                    <th class=''>
						<?php echo HTMLHelper::_('grid.sort', 'COM_JED_VEL_GENERAL_FIELD_EMAIL_LABEL', 'a.reporter_email', $listDirn, $listOrder); ?>
                    </th>
                    <th class=''>
                    ...
                    <th class=''>
						<?php echo HTMLHelper::_('grid.sort', 'COM_JED_VEL_ABANDONEDREPORTS_FIELD_DATA_SOURCE_LABEL', 'a.data_source', $listDirn, $listOrder); ?>
                    </th>
                    <th class=''>
