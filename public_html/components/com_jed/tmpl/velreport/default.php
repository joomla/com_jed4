...
if (!is_null($this->item))
{
    ...
    <div class="item_fields">
        ...
        <table class="table">
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_PASS_DETAILS_OK_LABEL'); ?></th>
                <td><?php echo $this->item->pass_details_ok; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_TYPE_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABLE_ITEM_VERSION_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerable_item_version; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_EXPLOIT_TYPE_LABEL'); ?></th>
                <td><?php echo $this->item->exploit_type; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_EXPLOIT_OTHER_DESCRIPTION_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->exploit_other_description); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_DESCRIPTION_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->vulnerability_description); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_HOW_FOUND_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->vulnerability_how_found); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_ACTIVELY_EXPLOITED_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerability_actively_exploited; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_PUBLICLY_AVAILABLE_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_SPECIFIC_IMPACT_LABEL'); ?></th>
                <td><?php echo nl2br($this->item->vulnerability_specific_impact); ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_DEVELOPER_COMMUNICATION_TYPE_LABEL'); ?></th>
                <td><?php echo $this->item->developer_communication_type; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_DEVELOPER_PATCH_DOWNLOAD_URL_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_DEVELOPER_CONTACT_EMAIL_LABEL'); ?></th>
                <td><?php echo $this->item->developer_contact_email; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_TRACKING_DB_NAME_LABEL'); ?></th>
                <td><?php echo $this->item->tracking_db_name; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_TRACKING_DB_ID_LABEL'); ?></th>
                <td><?php echo $this->item->tracking_db_id; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_JED_URL_LABEL'); ?></th>
                <td><?php echo $this->item->jed_url; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_DEVELOPER_ADDITIONAL_INFO_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_VEL_ITEM_ID_LABEL'); ?></th>
                <td><?php echo $this->item->vel_item_id; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_DATA_SOURCE_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_REPORTS_FIELD_CREATED_BY_LABEL'); ?></th>
