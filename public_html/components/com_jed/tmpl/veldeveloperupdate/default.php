...
if (!is_null($this->item))
{
    ...
    <div class="item_fields">
        ...
        <table class="table">
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_VULNERABLE_ITEM_NAME_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerable_item_name; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_VULNERABLE_ITEM_VERSION_LABEL'); ?></th>
                <td><?php echo $this->item->vulnerable_item_version; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_EXTENSION_UPDATE_LABEL'); ?></th>
                <td><?php echo $this->item->extension_update; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_NEW_VERSION_NUMBER_LABEL'); ?></th>
                <td><?php echo $this->item->new_version_number; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_UPDATE_NOTICE_URL_LABEL'); ?></th>
                <td><?php echo $this->item->update_notice_url; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_CHANGELOG_URL_LABEL'); ?></th>
            ...
            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_VEL_ITEM_ID_LABEL'); ?></th>
                <td><?php echo $this->item->vel_item_id; ?></td>
            </tr>

            <tr>
                <th><?php echo Text::_('COM_JED_VEL_DEVELOPERUPDATES_FIELD_UPDATE_DATA_SOURCE_LABEL'); ?></th>
