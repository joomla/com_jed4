...
customElements.define('joomla-field-module-order', /*#__PURE__*/function (_HTMLElement) {
  ...
  _createClass(_class, [{
    ...
    value: function getNewOrder(originalPosition) {
      ...
      var moduleId = "".concat(this.getAttribute('data-module-id'));
      var orders = [];
      var that = this;
      Joomla.request({
        url: "".concat(url, "&client_id=").concat(clientId, "&position=").concat(originalPosition, "&module_id=").concat(moduleId),
        method: 'GET',
        perform: true,
        headers: {
        ...
        onSuccess: function onSuccess(resp) {
          ...
          if (_typeof(resp.messages) === 'object' && resp.messages !== null) {
