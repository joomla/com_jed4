    ...
    if (task === 'module.cancel' || document.formvalidator.isValid(document.getElementById('module-form'))) {
      ...
      if (window.self !== window.top) {
        if (window.parent.viewLevels) {
          ...
          if (updMenus === '-') {
            tmpMenu.innerHTML = "<span class=\"badge bg-danger\">".concat(Joomla.JText._('JNO'), "</span>");
          ...
          if (parseInt(updMenus, 10) === 0) {
            tmpMenu.innerHTML = "<span class=\"badge bg-info\">".concat(Joomla.JText._('JALL'), "</span>");
          ...
          if (parseInt(updMenus, 10) > 0) {
            if (window.parent.inMenus.indexOf(window.parent.menuId) >= 0) {
              if (window.parent.numMenus === window.parent.inMenus.length) {
                ...
                tmpMenu.innerHTML = "<span class=\"badge bg-success\">".concat(Joomla.JText._('JYES'), "</span>");
          ...
          if (parseInt(updStatus, 10) === 1) {
            tmpStatus.innerHTML = "<span class=\"badge bg-success\">".concat(Joomla.JText._('JYES'), "</span>");
          ...
          if (parseInt(updStatus, 10) === 0) {
            tmpStatus.innerHTML = "<span class=\"badge bg-danger\">".concat(Joomla.JText._('JNO'), "</span>");
          ...
          if (parseInt(updStatus, 10) === -2) {
            tmpStatus.innerHTML = "<span class=\"badge bg-secondary\">".concat(Joomla.JText._('JTRASHED'), "</span>");
