var Bootstrap = (function (exports) {
  ...
  $$3({ target: 'Array', proto: true, forced: !USES_TO_LENGTH$1 }, {
  ...
  $$4({ target: 'Number', stat: true, forced: Number.parseFloat != parseFloat$1 }, {
  ...
  $$8({ target: 'String', proto: true, forced: !MDN_POLYFILL_BUG && !CORRECT_IS_REGEXP_LOGIC }, {
    startsWith: function startsWith(searchString /* , position = 0 */) {
      var that = String(requireObjectCoercible$3(this));
  ...
  $$a({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 || !USES_TO_LENGTH$2 }, {
  ...
  defineJQueryPlugin(NAME$2, Collapse);
  ...
  defineJQueryPlugin(NAME$3, Carousel);
  ...
  */
  ...
  defineJQueryPlugin(NAME$5, Dropdown);
  ...
  defineJQueryPlugin(NAME$b, Toast);
