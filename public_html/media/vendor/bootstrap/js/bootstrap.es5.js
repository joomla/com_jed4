var Bootstrap = (function (exports) {
  ...
  var parseFloat$1 = require('../internals/number-parse-float');

  // `Number.parseFloat` method
  // https://tc39.es/ecma262/#sec-number.parseFloat
  $$3({ target: 'Number', stat: true, forced: Number.parseFloat != parseFloat$1 }, {
  ...
  var setInternalState$1 = require('../internals/internal-state').set;
  ...
  var FORCED = DESCRIPTORS$1 && isForced$1('RegExp', (!CORRECT_NEW || UNSUPPORTED_Y || fails$2(function () {
    re2[MATCH] = false;
  ...
  var SUPPORTS_Y = !fails$4(function () { return !RegExp(MAX_UINT32, 'y'); });
  ...
  $$8({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$1 || !USES_TO_LENGTH$2 }, {
  ...
  $$b({ target: 'Object', stat: true, forced: Object.assign !== assign }, {
    assign: assign
  });
  ...
  // Edge 14- issue
  var USES_TO_LENGTH$3 = arrayMethodUsesToLength$3('filter');

  // `Array.prototype.filter` method
  // https://tc39.es/ecma262/#sec-array.prototype.filter
  // with adding support of @@species
  $$c({ target: 'Array', proto: true, forced: !HAS_SPECIES_SUPPORT$2 || !USES_TO_LENGTH$3 }, {
  ...
  var USES_TO_LENGTH$4 = arrayMethodUsesToLength$4(FIND);
  ...
  $$d({ target: 'Array', proto: true, forced: SKIPS_HOLES || !USES_TO_LENGTH$4 }, {
  ...
  var Collapse = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto.show = function show() {
      ...
      if (actives) {
        ...
        activesData = tempActiveData ? Data.getData(tempActiveData, DATA_KEY$2) : null;
      ...
      if (actives) {
        actives.forEach(function (elemActive) {
          ...
          if (!activesData) {
            Data.setData(elemActive, DATA_KEY$2, null);
          }
        });
      }
    ...
    Collapse.collapseInterface = function collapseInterface(element, config) {
      ...
      var _config = Object.assign({}, Default, Manipulator.getDataAttributes(element), typeof config === 'object' && config ? config : {});
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$2] = Collapse.jQueryInterface;
  ...
  var USES_TO_LENGTH$5 = arrayMethodUsesToLength$5('indexOf', { ACCESSORS: true, 1: 0 });

  // `Array.prototype.indexOf` method
  // https://tc39.es/ecma262/#sec-array.prototype.indexof
  $$f({ target: 'Array', proto: true, forced: NEGATIVE_ZERO || !STRICT_METHOD || !USES_TO_LENGTH$5 }, {
  ...
  var parseInt$1 = require('../internals/number-parse-int');

  // `Number.parseInt` method
  // https://tc39.es/ecma262/#sec-number.parseint
  $$g({ target: 'Number', stat: true, forced: Number.parseInt != parseInt$1 }, {
    parseInt: parseInt$1
  });
  ...
  var Carousel = /*#__PURE__*/function (_BaseComponent) {
    ...
    Carousel.carouselInterface = function carouselInterface(element, config) {
      ...
      var _config = Object.assign({}, Default$1, Manipulator.getDataAttributes(element));
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$3] = Carousel.jQueryInterface;
  ...
  var arrayMethodUsesToLength$6 = require('../internals/array-method-uses-to-length');
  var CHROME_VERSION = require('../internals/engine-v8-version');
  var IS_NODE = require('../internals/engine-is-node');

  var STRICT_METHOD$1 = arrayMethodIsStrict$1('reduce');
  var USES_TO_LENGTH$6 = arrayMethodUsesToLength$6('reduce', { 1: 0 });
  ...
  $$h({ target: 'Array', proto: true, forced: !STRICT_METHOD$1 || !USES_TO_LENGTH$6 || CHROME_BUG }, {
  ...
  $$i({ target: 'Array', proto: true, forced: ES3_STRINGS || !STRICT_METHOD$2 }, {
  ...
  if (DESCRIPTORS$2 && !(NAME$4 in FunctionPrototype)) {
    defineProperty$2(FunctionPrototype, NAME$4, {
      configurable: true,
      get: function () {
        try {
  ...
  var arrayMethodUsesToLength$7 = require('../internals/array-method-uses-to-length');

  var STRICT_METHOD$3 = arrayMethodIsStrict$3('some');
  var USES_TO_LENGTH$7 = arrayMethodUsesToLength$7('some');

  // `Array.prototype.some` method
  // https://tc39.es/ecma262/#sec-array.prototype.some
  $$j({ target: 'Array', proto: true, forced: !STRICT_METHOD$3 || !USES_TO_LENGTH$7 }, {
  ...
  var arrayMethodUsesToLength$8 = require('../internals/array-method-uses-to-length');

  var STRICT_METHOD$4 = arrayMethodIsStrict$4('every');
  var USES_TO_LENGTH$8 = arrayMethodUsesToLength$8('every');

  // `Array.prototype.every` method
  // https://tc39.es/ecma262/#sec-array.prototype.every
  $$k({ target: 'Array', proto: true, forced: !STRICT_METHOD$4 || !USES_TO_LENGTH$8 }, {
    every: function every(callbackfn /* , thisArg */) {
      return $every(this, callbackfn, arguments.length > 1 ? arguments[1] : undefined);
    }
  });

  var collection$1 = require('../internals/collection');
  var collectionStrong$1 = require('../internals/collection-strong');

  // `Map` constructor
  // https://tc39.es/ecma262/#sec-map-objects
  module.exports = collection$1('Map', function (init) {
  ...
  */
  ...
  var arrayMethodIsStrict$5 = require('../internals/array-method-is-strict');
  ...
  // Old WebKit
  var STRICT_METHOD$5 = arrayMethodIsStrict$5('sort');
  ...
  var FORCED$3 = isForced$2(PROMISE, function () {
    ...
    if (!GLOBAL_CORE_JS_PROMISE) {
      ...
      if (V8_VERSION$1 === 66) return true;
      // Unhandled rejections tracking support, NodeJS Promise without it fails @@species test
      if (!IS_NODE$1 && !NATIVE_REJECTION_EVENT) return true;
    }
    // We need Promise#finally in the pure version for preventing prototype pollution
    if (IS_PURE$1 && !PromiseConstructor.prototype['finally']) return true;
  ...
  if (FORCED$3) {
    ...
    if (!IS_PURE$1 && typeof NativePromise == 'function') {
      ...
      // wrap fetch result
      if (typeof $fetch == 'function') $$m({ global: true, enumerable: true, forced: true }, {
        // eslint-disable-next-line no-unused-vars
        fetch: function fetch(input /* , init */) {
          return promiseResolve(PromiseConstructor, $fetch.apply(global$4, arguments));
        }
      });
    }
  }
  ...
  $$m({ target: PROMISE, stat: true, forced: IS_PURE$1 || FORCED$3 }, {
  ...
  var Dropdown = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._getPopperConfig = function _getPopperConfig() {
      ...
      return Object.assign({}, popperConfig, this._config.popperConfig);
    } // Static
    ;
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$5] = Dropdown.jQueryInterface;
      $.fn[NAME$5].Constructor = Dropdown;
  ...
  var Modal = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._getConfig = function _getConfig(config) {
      config = Object.assign({}, Default$3, config);
      typeCheckConfig(NAME$6, config, DefaultType$3);
      return config;
    };
    ...
    Modal.jQueryInterface = function jQueryInterface(config, relatedTarget) {
      return this.each(function () {
        ...
        var _config = Object.assign({}, Default$3, Manipulator.getDataAttributes(this), typeof config === 'object' && config ? config : {});
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$6] = Modal.jQueryInterface;
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$7] = Tooltip.jQueryInterface;
  ...
  var Default$5 = Object.assign({}, Tooltip.Default, {
    placement: 'right',
    trigger: 'click',
    content: '',
    template: '<div class="popover" role="tooltip">' + '<div class="popover-arrow"></div>' + '<h3 class="popover-header"></h3>' + '<div class="popover-body"></div>' + '</div>'
  });
  var DefaultType$5 = Object.assign({}, Tooltip.DefaultType, {
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$8] = Popover.jQueryInterface;
      $.fn[NAME$8].Constructor = Popover;
  ...
  var ScrollSpy = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._getConfig = function _getConfig(config) {
      ...
      typeCheckConfig(NAME$9, config, DefaultType$6);
      return config;
    };
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$9] = ScrollSpy.jQueryInterface;
      $.fn[NAME$9].Constructor = ScrollSpy;
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      ...
      $.fn[NAME$a] = Tab.jQueryInterface;
      $.fn[NAME$a].Constructor = Tab;
  ...
  Joomla.initialiseTabs = function (el, options) {
    if (!(el instanceof Element) && options.isJoomla) {
      var nSelector = el.split('.')[1];

      if (!nSelector) {
        throw new Error('The selector is invalid, check your PHP side');
      }

      var tab = document.querySelector("#" + nSelector + "Content");
      ...
      if (tab) {
        ...
        if (related.length) {
          related.forEach(function (element) {
            ...
            var ul = document.querySelector("#" + nSelector + "Tabs");
  ...
  var Toast = /*#__PURE__*/function (_BaseComponent) {
    ...
    _proto._getConfig = function _getConfig(config) {
      config = Object.assign({}, Default$7, Manipulator.getDataAttributes(this._element), typeof config === 'object' && config ? config : {});
  ...
  onDOMContentLoaded(function () {
    ...
    if ($) {
      var JQUERY_NO_CONFLICT = $.fn[NAME$b];
      $.fn[NAME$b] = Toast.jQueryInterface;
      $.fn[NAME$b].Constructor = Toast;

      $.fn[NAME$b].noConflict = function () {
        $.fn[NAME$b] = JQUERY_NO_CONFLICT;
