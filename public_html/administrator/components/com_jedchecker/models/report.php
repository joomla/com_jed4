...
class JEDcheckerReport extends JObject
{
	 ...
	 * 
	 * @param   string   $show_errors  - Show errors.
	 * @param   string   $show_compat  - Show compat.
	 * @param   string   $show_info  - Show info.
	 * @param   string   $show_warning  - Show warning.
	 *
	 * @return    string    The HTML report data
	 */
	public function getHTML($show_errors = true, $show_compat = true, $show_info = true, $show_warning = true)
	{
		$html = array();
		...
		else
		{
			...
			if ($warning_count > 0 && $show_warning)
			{
