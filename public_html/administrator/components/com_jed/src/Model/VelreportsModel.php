...
class VelreportsModel extends ListModel
{
	...
	public function getItems()
	{
		...
		{
			$oneItem->pass_details_ok    = Text::_('COM_JED_VEL_REPORTS_FIELD_PASS_DETAILS_OK_LABEL_OPTION_' . strtoupper($oneItem->pass_details_ok));
			$oneItem->vulnerability_type = Text::_('COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_TYPE_LABEL_OPTION_' . strtoupper($oneItem->vulnerability_type));
			$oneItem->exploit_type       = Text::_('COM_JED_VEL_GENERAL_FIELD_EXPLOIT_TYPE_LABEL_OPTION_' . strtoupper($oneItem->exploit_type));
			$oneItem->consent_to_process = Text::_('COM_JED_GENERAL_CONSENT_TO_PROCESS_OPTION_' . strtoupper($oneItem->consent_to_process));
			$oneItem->passed_to_vel      = Text::_('COM_JED_VEL_GENERAL_FIELD_PASSED_TO_VEL_LABEL_OPTION_' . strtoupper($oneItem->passed_to_vel));
