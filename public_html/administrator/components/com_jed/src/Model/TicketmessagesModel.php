...
class TicketmessagesModel extends ListModel
{
	...
	protected function getListQuery(): QueryInterface
	{
		...
		$query->select('`#__jed_jedtickets_3591992`.`ticket_subject` AS jedtickets_fk_value_3591992');
		$query->join('LEFT', '#__jed_jedtickets AS #__jed_jedtickets_3591992 ON #__jed_jedtickets_3591992.`id` = a.`ticket_id`');
