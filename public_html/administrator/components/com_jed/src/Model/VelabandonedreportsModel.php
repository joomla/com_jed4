...
class VelabandonedreportsModel extends ListModel
{
	...
	public function getItems()
	{
		...
		foreach ($items as $oneItem)
		{
			...
			$oneItem->passed_to_vel      = Text::_('COM_JED_VEL_ABANDONEDREPORTS_PASSED_TO_VEL_OPTION_' . strtoupper($oneItem->passed_to_vel));
			$oneItem->data_source        = Text::_('COM_JED_VEL_ABANDONEDREPORTS_FIELD_DATA_SOURCE_LABEL_OPTION_' . strtoupper($oneItem->data_source));
		}
