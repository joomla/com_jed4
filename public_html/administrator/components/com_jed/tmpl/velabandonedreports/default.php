		...
		<div class="col-md-12">
			<div id="j-main-container" class="j-main-container">
				...
				<?php echo HTMLHelper::_('searchtools.sort',  'JGLOBAL_FIELD_ID_LABEL', 'a.`id`', $listDirn, $listOrder); ?>
                        ...
                        <th class='left'>
				<?php echo HTMLHelper::_('searchtools.sort',  'COM_JED_VEL_ABANDONEDREPORTS_EXTENSION_NAME', 'a.`extension_name`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<th class='left'>
				<?php echo HTMLHelper::_('searchtools.sort',  'COM_JED_VEL_ABANDONEDREPORTS_EXTENSION_VERSION', 'a.`extension_version`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('searchtools.sort',  'COM_JED_GENERAL_FIELD_NAME_LABEL', 'a.`reporter_fullname`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('searchtools.sort',  'COM_JED_VEL_GENERAL_FIELD_EMAIL_LABEL', 'a.`reporter_email`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				...
				<th class='left'>
				<?php echo HTMLHelper::_('searchtools.sort',  'COM_JED_VEL_ABANDONEDREPORTS_FIELD_DATA_SOURCE_LABEL', 'a.`data_source`', $listDirn, $listOrder); ?>
				</th>
				<th class='left'>
				<?php echo HTMLHelper::_('searchtools.sort',  'COM_JED_VEL_ABANDONEDREPORTS_DATE_SUBMITTED', 'a.`date_submitted`', $listDirn, $listOrder); ?>
				</th>
