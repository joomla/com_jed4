            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <table class="table table-striped" id="velreportList">
                    ...
                    <tr>
                        ...
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_VEL_REPORTS_FIELD_PASS_DETAILS_OK_LABEL', 'a.`pass_details_ok`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_VEL_REPORTS_FIELD_VULNERABILITY_TYPE_LABEL', 'a.`vulnerability_type`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                        ...
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_VEL_REPORTS_FIELD_DATA_SOURCE_LABEL', 'a.`data_source`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
