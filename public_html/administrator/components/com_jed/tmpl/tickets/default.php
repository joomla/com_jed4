...
use Joomla\Component\Jed\Administrator\View\Reviews\HtmlView;
...
$canOrder  = $user->authorise('core.edit.state', 'com_jed.tickets');
$saveOrder = $listOrder === 't.ordering';
?>
<form id="adminForm" action="<?php echo Route::_('index.php?option=com_jed&view=tickets'); ?>" method="post" name="adminForm">
    <div class="row">
        <div class="col-md-12">
                ...
                <?php else : ?>
                    ...
                    <tr>
                        ...
                        <td scope="col" class="w-1 text-center d-none d-md-table-cell">
							<?php echo HTMLHelper::_('searchtools.sort', 'JPUBLISHED', 'tickets.published', $listDirn, $listOrder); ?>
                        </td>
                        <td scope="col" class="w-1 text-center d-none d-md-table-cell">
							<?php echo HTMLHelper::_('searchtools.sort', 'JGLOBAL_FIELD_CREATED_LABEL', 'tickets.created_on', $listDirn, $listOrder); ?>
                        </td>
                        <td scope="col" class="w-1 text-center">
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_REVIEWS_TITLE', 'tickets.title', $listDirn, $listOrder); ?>
                        </td>
                        ...
                        <td scope="col" class="w-3 d-none d-lg-table-cell">
							<?php echo HTMLHelper::_('searchtools.sort', 'JGRID_HEADING_ID', 'tickets.id', $listDirn, $listOrder); ?>
                        </td>
                    </tr>
                    </thead>
                    <tbody>
                        ...
                        foreach ($this->items as $i => $item):
                            ...
                            $canChange  = $user->authorise('core.edit.state', 'com_jed.tickets.' . $item->id) && $canCheckin;
                            ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <a href="<?php echo 'index.php?option=com_jed&task=ticket.edit&id=' . (int) $item->id; ?>">
                                        <?php echo $item->title; ?>
                                    </a>
                                </td>
                                <td>
