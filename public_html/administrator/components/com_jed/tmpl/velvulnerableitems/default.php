            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <table class="table table-striped" id="velvulnerableitemList">
                    ...
                    <tr>
                        ...
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_VELVULNERABLEITEMS_TITLE', 'a.`title`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'JSTATUS', 'a.`status`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_VEL_VULNERABLEITEMS_FIELD_REPORT_ID_LABEL', 'a.`report_id`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_VEL_FIELD_JED_URL_LABEL', 'a.`jed`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_VEL_VULNERABLEITEMS_FIELD__LABEL', 'a.`alias`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_GENERAL_FIELD_CREATED_ON_LABEL_BY', 'a.`created_by`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_GENERAL_FIELD_MODIFIED_ON_LABEL_BY', 'a.`modified_by`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
					...
					<?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <td>
								...
								<?php echo $item->vel_report_title; ?>
                            </td>
                            <td>
