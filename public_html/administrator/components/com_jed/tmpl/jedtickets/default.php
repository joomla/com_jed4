            ...
            <div id="j-main-container" class="j-main-container">
                ...
                <table class="table table-striped" id="jedticketList">
                    ...
                    <tr>
                        ...
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_JEDTICKETS_FIELD_TICKET_ORIGIN_LABEL', 'a.`ticket_origin`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                        ...
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_JEDTICKETS_FIELD_LINKED_ITEM_ID_LABEL', 'a.`linked_item_id`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_JEDTICKETS_FIELD_TICKET_STATUS_LABEL', 'a.`ticket_status`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_JEDTICKETS_FIELD_PARENT_ID_LABEL', 'a.`parent_id`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                        ...
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_JEDTICKETS_FIELD_CREATED_ON_LABEL', 'a.`created_on`', $listDirn, $listOrder); ?>
                        </th>
                        <th class='left'>
                            <?php echo HTMLHelper::_('searchtools.sort', 'COM_JED_JEDTICKETS_FIELD_MODIFIED_ON_LABEL', 'a.`modified_on`', $listDirn, $listOrder); ?>
                        </th>
                    ...
                    <?php foreach ($this->items as $i => $item) :
                        ...
                        <tr class="row<?php echo $i % 2; ?>">
                            ...
                            <?php if (isset($this->items[0]->state)): ?>
                                <td class="center">
                                    <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'jedtickets.', $canChange, 'cb'); ?>
                                </td>
                            <?php endif; ?>
                            ...
                            <td>
                                ...
                                <?php echo $item->ticket_origin; ?>
                            </td>
                            <td>

                                <?php echo $item->ticket_category_type; ?>
                            </td>
                            <td>
                            ...
                            <td>
                                ...
                                <?php echo $item->linked_item_type; ?>
                            </td>
                            <td>

                                <?php echo $item->linked_item_id; ?>
                            </td>
                            <td>
