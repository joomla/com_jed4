...
$canOrder  = $user->authorise('core.edit.state', 'com_jed.revews');
				...
				<table class="table table-striped" id="reviewList">
					...
					foreach ($this->items as $i => $item):
						...
						<tr>
							...
							<td>
								<a href="<?php echo 'index.php?option=com_jed&task=reviews.view&id=' . (int) $item->id; ?>">
									<?php echo $item->title; ?>
								</a>
							</td>
							<td>
