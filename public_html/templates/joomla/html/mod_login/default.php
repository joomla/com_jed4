...
$return = $input->getString('return', $return);

?>
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline fabrik-form">
	<fieldset>
	<legend></legend>
			...
			<div class="controls">
				<?php if (!$params->get('usetext')) : ?>
					<div class="input-prepend input-append">
						...
						<input id="modlgn-secretkey" autocomplete="off" type="text" name="secretkey" class="input-medium" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_SECRETKEY') ?>" />
